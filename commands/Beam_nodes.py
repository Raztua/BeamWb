...
class ManageNodesCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                Beam_Tools.getBeamModulePath(), "icons", "beam_node_manager.svg"
            ),
...
class CreateNodeCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                Beam_Tools.getBeamModulePath(), "icons", "beam_node_create.svg"
            ),
...
class ModifyNodeCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                Beam_Tools.getBeamModulePath(), "icons", "beam_node_modify.svg"
            ),
...
class OffsetNodeCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                Beam_Tools.getBeamModulePath(), "icons", "beam_node_offset.svg"
            ),
