...
class CreateLoadIDCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                BeamTools.getBeamModulePath(), "icons", "beam_load_ID.svg"
            ),
...
class CreateMemberLoadCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                BeamTools.getBeamModulePath(), "icons", "beam_member_load.svg"
            ),
...
class CreateAccelerationLoadCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                BeamTools.getBeamModulePath(), "icons", "beam_acceleration_load.svg"
            ),
...
class CreateNodalLoadCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                BeamTools.getBeamModulePath(), "icons", "beam_nodal_load.svg"
            ),
...
class CreateDistributedLoadCommand:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                BeamTools.getBeamModulePath(), "icons", "beam_distributed_load.svg"
            ),
